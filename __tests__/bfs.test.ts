...
describe("findShortestPathFromGraph", () => {
  ...
  it("finds a simple path A-B-C", () => {
    ...
    const edge = (neighborId: number) => ({ neighborId, gameCount: 1, classicalCount: 1, firstGameYear: null, lastGameYear: null });
    adj.set(1, [edge(2)]);
  ...
  it("respects chronological incompatibility between players", () => {
    ...
    const e12 = { neighborId: 2, gameCount: 1, classicalCount: 1, firstGameYear: 1840, lastGameYear: 1845 };
    const e23 = { neighborId: 3, gameCount: 1, classicalCount: 1, firstGameYear: 1905, lastGameYear: 1910 };
    adj.set(1, [e12]);
    adj.set(2, [{ neighborId:1, gameCount:1, classicalCount:1, firstGameYear:1840, lastGameYear:1845 }, e23]);
    adj.set(3, [{ neighborId:2, gameCount:1, classicalCount:1, firstGameYear:1905, lastGameYear:1910 }]);
  ...
  it("honors time-control filter (classical) by ignoring edges with classicalCount=0", () => {
    ...
    const adj = new Map<number, any>();
    const pMap = new Map<number, Player>([[1, makePlayer(1)], [2, makePlayer(2)], [3, makePlayer(3)]]);
    const e12 = { neighborId: 2, gameCount: 5, classicalCount: 0, firstGameYear: null, lastGameYear: null };
    const e21 = { neighborId: 1, gameCount: 5, classicalCount: 0, firstGameYear: null, lastGameYear: null };
    const e23 = { neighborId: 3, gameCount: 2, classicalCount: 0, firstGameYear: null, lastGameYear: null };
    const e32 = { neighborId: 2, gameCount: 2, classicalCount: 0, firstGameYear: null, lastGameYear: null };
    adj.set(1, [e12]);
    adj.set(2, [e21, e23]);
    adj.set(3, [e32]);
